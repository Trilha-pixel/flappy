...
var DEBUG, FLAP, GAME_HEIGHT, GRAVITY, GROUND_HEIGHT, GROUND_Y, HEIGHT, OPENING, SCALE, SPAWN_RATE, SPEED, WIDTH, WebFontConfig, atualizarPontos, atualizarSaldo, bannerVisivel, bg, bird, carregarSaldo, deadInvs, deadTubeBottoms, deadTubeTops, fallSnd, flapSnd, floatingText, floor, gameOver, gameOverText, gameStarted, generateLeaderboard, ground, hurtSnd, instText, invs, lastMsg, main, multiplicador, multiplierTimer, parent, pontosText, saldoAcumulado, saldoText, salvarSaldo, scheduleSocialProof, score, scoreSnd, scoreText, sessionEarnings, showHypeMessage, showNotification, swooshSnd, taxaPorSegundo, tentativasRestantes, tubes, tubesTimer, valorPorCano;
...
main = function() {
  ...
  addScore = function(_, inv) {
    ...
    if (saldoText) {
      ...
      saldoText.fontSize = "10px";
      game.time.events.add(200, function() {
        return saldoText.fontSize = "8px";
      });
    }
    tubes.forEachAlive(function(tube) {
      return tube.tint = 0xFFD700;
    });
    showHypeMessage();
  };
