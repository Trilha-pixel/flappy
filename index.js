...
main = function() {
  ...
  update = function() {
    var comboBonus, dt, gain, now, s, s2, scaleVal, survivalBonus, tween;
    if (gameStarted) {
      if (!gameOver) {
